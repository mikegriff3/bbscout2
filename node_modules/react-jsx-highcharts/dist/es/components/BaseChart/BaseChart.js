...
function (_Component) {
  ...
  function BaseChart(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "initHighcharts", function () {
      if (!_this.domNode) {
        return;
      }
      ...
      var _this$props = _this.props,
          ...
          styledMode = _this$props.styledMode,
          children = _this$props.children,
          rest = _objectWithoutProperties(_this$props, ["chartCreationFunc", "callback", "chart", "polar", "gauge", "styledMode", "children"]);
    ...
    _defineProperty(_assertThisInitialized(_this), "needsRedraw", debounce(function () {
      if (!_this.chart.__destroyed) {
        attempt(_this.chart.redraw.bind(_this.chart));
      }
    }));
