...
module.exports = {
        ...
        .update(
          {
            ...
            W: team["W"],
            L: team["L"],
            GP: parseInt(team["W"]) + parseInt(team["L"]),
            MOV: team["MOV"],
            // SOS: team["SOS"],
            // SRS: team["SRS"],
            // ORtg: team["ORtg"],
        ...
        .update(
          {
            ...
            DRtg: team["DRtg"],
            PACE: team["PACE"],
            OFF_eFG_PCT: team["OFF_eFG_PCT"],
            OFF_TOV_PCT: team["OFF_TOV_PCT"],
  ...
  updateGPlayerAdvancedStats: (req, res) => {
    console.log("REQ\n", req.body.data);
    var players = req.body.data;
  ...
  updateCPlayerAdvancedStats: (req, res) => {
    console.log("REQ\n", req.body.data);
    var players = req.body.data;
    for (var i = 1400; i < players.length; i++) {
      var player = players[i];
      db.cPlayers
        .update(
          {
  ...
  updateCollegePlayers: (req, res) => {
    console.log("REQ\n", req.body.data);
    var players = req.body.data;
    for (var i = 1700; i < players.length; i++) {
      var player = players[i];
      db.cPlayers
        .update(
          {
