...
const catchShootDB = require("./config").catchShootDB;
const hustleDB = require("./config").hustleDB;
const isolationDB = require("./config").isolationDB;
const postUpDB = require("./config").postUpDB;
const prbhDB = require("./config").prbhDB;
const prrmDB = require("./config").prrmDB;
const shootingDB = require("./config").shootingDB;
const speedDistanceDB = require("./config").speedDistanceDB;
const transitionDB = require("./config").transitionDB;
...
const PostUp = postUpDB.define("postUp", {
  name: { type: Sequelize.STRING, allowNull: false },
...
const Shooting = shootingDB.define("shooting", {
  name: { type: Sequelize.STRING, allowNull: false },
...
const CatchShoot = catchShootDB.define("catchShoot", {
  name: { type: Sequelize.STRING, allowNull: false },
  pts: { type: Sequelize.FLOAT, allowNull: true },
  fgm: { type: Sequelize.FLOAT, allowNull: true },
  fga: { type: Sequelize.FLOAT, allowNull: true },
...
const SpeedDistance = speedDistanceDB.define("speedDistance", {
  name: { type: Sequelize.STRING, allowNull: false },
...
const PRBallHandler = prbhDB.define("prBallHandler", {
  name: { type: Sequelize.STRING, allowNull: false },
...
const PRRollMan = prrmDB.define("prRollMan", {
  name: { type: Sequelize.STRING, allowNull: false },
  freq: { type: Sequelize.FLOAT, allowNull: true },
  ppp: { type: Sequelize.FLOAT, allowNull: true },
  pts: { type: Sequelize.FLOAT, allowNull: true },
...
const Isolation = isolationDB.define("isolation", {
  name: { type: Sequelize.STRING, allowNull: false },
  freq: { type: Sequelize.FLOAT, allowNull: true },
  ppp: { type: Sequelize.FLOAT, allowNull: true },
  pts: { type: Sequelize.FLOAT, allowNull: true },
...
const Transition = transitionDB.define("transition", {
  name: { type: Sequelize.STRING, allowNull: false },
  freq: { type: Sequelize.FLOAT, allowNull: true },
  ppp: { type: Sequelize.FLOAT, allowNull: true },
  pts: { type: Sequelize.FLOAT, allowNull: true },
...
const Hustle = hustleDB.define("hustle", {
  name: { type: Sequelize.STRING, allowNull: false },
...
const Teams = db.define("team", {
  ...
  GP: { type: Sequelize.INTEGER, allowNull: true },
  FG: { type: Sequelize.FLOAT, allowNull: true },
  FGA: { type: Sequelize.FLOAT, allowNull: true },
  FG_PCT: { type: Sequelize.FLOAT, allowNull: true },
  Three_Pointers: { type: Sequelize.FLOAT, allowNull: true },
  Three_Pointers_Att: { type: Sequelize.FLOAT, allowNull: true },
  Three_Pointers_Pct: { type: Sequelize.FLOAT, allowNull: true },
  Two_Pointers: { type: Sequelize.FLOAT, allowNull: true },
  Two_Pointers_Att: { type: Sequelize.FLOAT, allowNull: true },
  Two_Pointers_Pct: { type: Sequelize.FLOAT, allowNull: true },
  FTM: { type: Sequelize.FLOAT, allowNull: true },
  FTA: { type: Sequelize.FLOAT, allowNull: true },
  FT_PCT: { type: Sequelize.FLOAT, allowNull: true },
  ORB: { type: Sequelize.FLOAT, allowNull: true },
  DRB: { type: Sequelize.FLOAT, allowNull: true },
  TRB: { type: Sequelize.FLOAT, allowNull: true },
  AST: { type: Sequelize.FLOAT, allowNull: true },
  STL: { type: Sequelize.FLOAT, allowNull: true },
  BLK: { type: Sequelize.FLOAT, allowNull: true },
  ...
  PF: { type: Sequelize.FLOAT, allowNull: true },
  PTS: { type: Sequelize.FLOAT, allowNull: true },
  W: { type: Sequelize.INTEGER, allowNull: true },
  L: { type: Sequelize.INTEGER, allowNull: true },
  PW: { type: Sequelize.FLOAT, allowNull: true },
  PL: { type: Sequelize.FLOAT, allowNull: true },
  MOV: { type: Sequelize.FLOAT, allowNull: true },
  SOS: { type: Sequelize.FLOAT, allowNull: true },
  SRS: { type: Sequelize.FLOAT, allowNull: true },
  ORtg: { type: Sequelize.FLOAT, allowNull: true },
  DRtg: { type: Sequelize.FLOAT, allowNull: true },
  PACE: { type: Sequelize.FLOAT, allowNull: true },
  FTr: { type: Sequelize.FLOAT, allowNull: true },
  Three_PAr: { type: Sequelize.FLOAT, allowNull: true },
  OFF_eFG_PCT: { type: Sequelize.FLOAT, allowNull: true },
  OFF_TOV_PCT: { type: Sequelize.FLOAT, allowNull: true },
  ORB_PCT: { type: Sequelize.FLOAT, allowNull: true },
  OFF_FT_FGA: { type: Sequelize.FLOAT, allowNull: true },
  DEF_eFG_PCT: { type: Sequelize.FLOAT, allowNull: true },
  DEF_TOV_PCT: { type: Sequelize.FLOAT, allowNull: true },
  DRB_PCT: { type: Sequelize.FLOAT, allowNull: true },
  DEF_FT_FGA: { type: Sequelize.FLOAT, allowNull: true },
  oFG: { type: Sequelize.FLOAT, allowNull: true },
  oFGA: { type: Sequelize.FLOAT, allowNull: true },
  oFGPCT: { type: Sequelize.FLOAT, allowNull: true },
  o3P: { type: Sequelize.FLOAT, allowNull: true },
  o3PA: { type: Sequelize.FLOAT, allowNull: true },
  o3PCT: { type: Sequelize.FLOAT, allowNull: true },
  o2P: { type: Sequelize.FLOAT, allowNull: true },
  o2PA: { type: Sequelize.FLOAT, allowNull: true },
  o2PCT: { type: Sequelize.FLOAT, allowNull: true },
  oFTM: { type: Sequelize.FLOAT, allowNull: true },
  oFTA: { type: Sequelize.FLOAT, allowNull: true },
  oFTPCT: { type: Sequelize.FLOAT, allowNull: true },
  oORB: { type: Sequelize.FLOAT, allowNull: true },
  oDRB: { type: Sequelize.FLOAT, allowNull: true },
  oTRB: { type: Sequelize.FLOAT, allowNull: true },
  oAST: { type: Sequelize.FLOAT, allowNull: true },
  oSTL: { type: Sequelize.FLOAT, allowNull: true },
  oBLK: { type: Sequelize.FLOAT, allowNull: true },
  oTOV: { type: Sequelize.FLOAT, allowNull: true },
  oPF: { type: Sequelize.FLOAT, allowNull: true },
  oPTS: { type: Sequelize.FLOAT, allowNull: true },
  Logo: { type: Sequelize.STRING, allowNull: true },
  Color_Main: { type: Sequelize.STRING, allowNull: true },
  Color_Sec: { type: Sequelize.STRING, allowNull: true },
  Color_Third: { type: Sequelize.STRING, allowNull: true },
