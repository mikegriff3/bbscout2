...
export default class PostUpPolar extends React.Component {
  ...
  calculateGrades() {
    ...
    var tovPct = this.getGrade(highTov, this.state.player.tovPct * -1, -0.24);
    this.setState(
      {
        ast: ast,
        fg: fg,
      ...
      series: [
        {
          ...
          data: [
            ...
            {
              y: this.state.pass.Grade - 6,
              temp: this.state.pass.Grade,
              color: this.state.pass.Color,
              borderColor: this.state.pass.ColorStroke,
              borderWidth: 3,
              name: "Pass%",
              stat: (this.state.player.passPct * 100).toFixed(1),
            },
            {
            ...
            {
              y: this.state.postUps.Grade - 6,
              temp: this.state.postUps.Grade,
            ...
            {
              y: this.state.ptsPct.Grade - 6,
              temp: this.state.ptsPct.Grade,
