      ...
      series: [
        {
          ...
          data: [
            {
              y: this.state.astPct.Grade - 6,
              temp: this.state.astPct.Grade,
            ...
            {
              y: this.state.tovPct.Grade - 6,
              temp: this.state.tovPct.Grade,
            ...
            {
              y: this.state.orbPct.Grade - 6,
              temp: this.state.orbPct.Grade,
            ...
            {
              y: this.state.tsPct.Grade - 6,
              temp: this.state.tsPct.Grade,
            ...
            {
              y: this.state.ftr.Grade - 6,
              temp: this.state.ftr.Grade,
            ...
            {
              y: this.state.threePAr.Grade - 6,
              temp: this.state.threePAr.Grade,
            ...
            {
              y: this.state.obpm.Grade - 6,
              temp: this.state.obpm.Grade,
            ...
            {
              y: this.state.usgPct.Grade - 6,
              temp: this.state.usgPct.Grade,
