...
export default class PRBHPolar extends React.Component {
  constructor() {
    super();
  ...
  calculateGrades() {
    ...
    var freq = this.getGrade(highFreq, this.state.player.freq * 100, 5.5);
    ...
    var efg = this.getGrade(highEfg, this.state.player.efg * 100, 20.0);
      ...
      series: [
        {
          ...
          data: [
            ...
            },
            {
              ...
              borderWidth: 3,
              name: "TOV Freq.",
              stat: (this.state.player.toFreq * 100).toFixed(1),
            },
            {
              ...
              borderWidth: 3,
              name: "FT Freq.",
              stat: (this.state.player.ftFreq * 100).toFixed(1),
            },
            {
