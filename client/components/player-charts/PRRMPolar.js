...
export default class PRRMPolar extends React.Component {
  constructor() {
    super();
  ...
  calculateGrades() {
    ...
    var freq = this.getGrade(highFreq, this.state.player.freq * 100, 1.0);
    ...
    var efg = this.getGrade(highEfg, this.state.player.efg * 100, 30.0);
