  ...
  createChart() {
    var chart = Highcharts.chart("container-hustle", {
      ...
      tooltip: {
        ...
        pointFormat: `<span>Rating: {point.temp}</span><br/><span>Stat: {point.stat}</span><br/><span>Per 36: {point.per36}</span>`,
        style: {
          fontSize: "1.6rem",
        },
      },
      ...
      series: [
        {
          ...
          data: [
            {
              y: this.state.screenAst.Grade - 6,
              temp: this.state.screenAst.Grade,
            ...
            {
              y: this.state.chargesDrawn.Grade - 6,
              temp: this.state.chargesDrawn.Grade,
            ...
            {
              y: this.state.looseBallRec.Grade - 6,
              temp: this.state.looseBallRec.Grade,
            ...
            {
              y: this.state.deflections.Grade - 6,
              temp: this.state.deflections.Grade,
            ...
            {
              y: this.state.contestedTwo.Grade - 6,
              temp: this.state.contestedTwo.Grade,
            ...
            {
              y: this.state.contestedThree.Grade - 6,
              temp: this.state.contestedThree.Grade,
            ...
            {
              y: this.state.contestedShots.Grade - 6,
              temp: this.state.contestedShots.Grade,
