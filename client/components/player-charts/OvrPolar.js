      ...
      series: [
        {
          ...
          data: [
            ...
            {
              y: this.state.wsFourtyEight.Grade - 6,
              temp: this.state.wsFourtyEight.Grade,
            ...
            {
              y: this.state.vorp.Grade - 6,
              temp: this.state.vorp.Grade,
            ...
            {
              y: this.state.bpm.Grade - 6,
              temp: this.state.bpm.Grade,
