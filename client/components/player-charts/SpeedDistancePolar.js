  ...
  createChart() {
    var chart = Highcharts.chart("container-column-speed", {
      ...
      tooltip: {
        ...
        pointFormat: `<span>Rating: {point.temp}</span><br/><span>Stat: {point.stat}</span>`,
        style: {
          fontSize: "1.6rem",
        },
      },
      ...
      series: [
        {
          ...
          data: [
            {
              y: this.state.distMiles.Grade - 6,
              temp: this.state.distMiles.Grade,
            ...
            {
              y: this.state.distMilesO.Grade - 6,
              temp: this.state.distMilesO.Grade,
            ...
            {
              y: this.state.distMilesD.Grade - 6,
              temp: this.state.distMilesD.Grade,
            ...
            {
              y: this.state.speed.Grade - 6,
              temp: this.state.speed.Grade,
            ...
            {
              y: this.state.speedO.Grade - 6,
              temp: this.state.speedO.Grade,
            ...
            {
              y: this.state.speedD.Grade - 6,
              temp: this.state.speedD.Grade,
