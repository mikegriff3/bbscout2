...
import CPolarArea from "./player-charts/CPolarArea";
import CPolarColumn from "./player-charts/CPolarColumn";
import CDefPolar from "./player-charts/CDefPolar";
import COffPolar from "./player-charts/COffPolar";
import COvrPolar from "./player-charts/COvrPolar";

export default class CPlayerRatings extends React.Component {
  constructor() {
    super();
    this.state = {
      statCat: "Basic",
  ...
  renderPolarCol() {
    if (this.state.statCat === "Basic") {
      return <CPolarColumn player={this.props.player} />;
    } else if (this.state.statCat === "Offense") {
      return <COffPolar player={this.props.player} />;
      ...
      return <CDefPolar player={this.props.player} />;
    } else if (this.state.statCat === "Overall") {
      return <COvrPolar player={this.props.player} />;
      ...
      <div className="player-ratings-container">
        <div className="row">
          ...
          <div className="polar-area-container col-md-6 col-xs-12">
            <CPolarArea player={this.props.player} colors={this.props.colors} />
          </div>
        </div>
        <div className="row">
