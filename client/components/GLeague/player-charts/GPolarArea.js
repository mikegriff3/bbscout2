...
export default class GPolarArea extends React.Component {
  constructor() {
    super();
  ...
  calculateGrades() {
    ...
    var twoPoint = this.getGrade(highTwo, this.state.player.efgPct, 0.25);
    this.setState(
      {
        scoring: scoring,
        ast: ast,
  ...
  createChart() {
    var chart = Highcharts.chart("container-polar3", {
      chart: {
        polar: true,
        type: "area",
  ...
  render() {
    return (
      <div>
        <div id="container-polar3" style={{ height: "30rem" }} />
      </div>
    );
  }
}
