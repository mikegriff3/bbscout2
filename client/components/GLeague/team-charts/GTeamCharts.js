...
import GPlayerStats from "./GPlayerStats";

export default class GTeamCharts extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
      ...
      .then((data) => {
        ...
        for (var j = 0; j < playerData.length; j++) {
          ...
          scatterData.push({
            data: [
              [
                playerData[j][this.state.xStat],
                playerData[j][this.state.yStat],
              ],
            ],
  ...
  render() {
    ...
    return (
      <div className="team__chart-section">
        ...
        <GPlayerStats players={this.props.players} />
        <div
          className="hr-box"
          style={{ backgroundColor: "rgba(0,0,0,0.7)", padding: "0 80px" }}
        >
