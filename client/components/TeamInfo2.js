...
class TeamInfo2 extends React.Component {
  ...
  getDefenseRating() {
    if (this.state.team) {
      var defRating = parseFloat(this.state.team.DRtg * -1);
      var grade = this.getGrade(-104.0, -113.0, defRating);
      if (grade.Grade === 80) {
        return (
          <button
            style={{
              ...
              >
                ...
                >
                  <div className="team-image-box">
                    <a href={`/gleague-team/${this.state.team.Color_Sec}`}>
                      <img
...
export default connect(mapStateToProps, mapDispatchToProps)(TeamInfo2);
