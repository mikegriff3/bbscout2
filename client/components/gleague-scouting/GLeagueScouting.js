...
import GPlayerScatter from "./gleague-scouting-charts/GPlayerScatter";
...
export default class GLeagueScouting extends React.Component {
  constructor() {
    ...
    this.getAllGLeaguePlayers = this.getAllGLeaguePlayers.bind(this);
  ...
  getOffensiveRating(player) {
    ...
    return this.getGrade(97, 0, ovrOff);
  }
  ...
  getDefensiveRating(player) {
    ...
    return this.getGrade(80, 0, ovrDef);
  }
  ...
  calculateOffGrades(player) {
    ...
    grades.pie = this.getGrade(highPie, 0, player.plusMinus * 100);
    ...
    grades.ortg = this.getGrade(highORtg, 80.0, player.obpm);
    ...
    grades.efgPct = this.getGrade(highFgPct, 0.25, player.efgPct);
  ...
  calculateDefGrades(player) {
    ...
    grades.drtg = this.getGrade(highDRtg, -120, player.dbpm * -1);
